...
///
/// ErplyResponsiveGridView extends [GridView] with
/// a custom [ErplyResponsiveGridDelegate] [gridDelegate]
/// that adds more grid layout controls.
/// See [ErplyResponsiveGridDelegate] for shrink and
...
class ErplyResponsiveGridView extends StatelessWidget {
  ...
  final ErplyResponsiveGridDelegate gridDelegate;
  ...
  const ErplyResponsiveGridView.builder({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      ...
      return Container(
        ...
        child: _ErplyResponsiveGridViewLayout(
...
class _ErplyResponsiveGridViewLayout extends BoxScrollView {
  final ErplyResponsiveGridDelegate gridDelegate;
  final SliverChildDelegate childrenDelegate;
  final int? itemCount;

  const _ErplyResponsiveGridViewLayout({
    // super.key,
...
class ErplyResponsiveGridDelegate extends SliverGridDelegate {
  const ErplyResponsiveGridDelegate({
  ...
  @override
  bool shouldRelayout(ErplyResponsiveGridDelegate oldDelegate) {
